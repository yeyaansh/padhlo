1. when we refresh a page, we can't go back to the previous page - stuck to the same page (only forward is allowed then no backward) // I guess this happened due to use of navigate and location
